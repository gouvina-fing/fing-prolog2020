...
% es_transicion_determinista(_L)
% Comprueba que una serie de transiciones conforman las aristas de un AFD (no hay 2 transiciones con mismo origen y Simbolo de transición)
